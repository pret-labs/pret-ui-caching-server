...
if (![ChainId.mainnet, ChainId.polygon, ChainId.avalanche, ChainId.aurora_mainnet].includes(CHAIN_ID)) {
...
const CONFIGS: {
  ...
  [ChainId.aurora_mainnet]: {
    BLOCK_NUMBER_POOLING_INTERVAL: 5000,
    PROTOCOL_ADDRESSES_PROVIDER_ADDRESSES: ['0xEE5ff33b3E41D60f23963C167fdC1d627Fb672DB'],
    PROTOCOLS_WITH_INCENTIVES_ADDRESSES: ['0xEE5ff33b3E41D60f23963C167fdC1d627Fb672DB'],
    POOL_UI_DATA_PROVIDER_ADDRESS: '0xAaA29ade0530DbAD7fDe95090364eC9ba5c973B6',
    UI_INCENTIVE_DATA_PROVIDER_ADDRESS: '0x16Dea0fCBca21E848714B2e96f26ddF6BCe505C9',
    GENERAL_RESERVES_DATA_POOLING_INTERVAL: 1000,
    USERS_DATA_POOLING_INTERVAL: 1000,
    RESERVE_INCENTIVES_DATA_POOLING_INTERVAL: 1000,
